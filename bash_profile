...
# Check if uname is Linux and add Linuxbrew to path
if [ `uname` == "Linux" ]; then
...
[[ -f ~/.dircolors/dircolors.ansi-dark ]] && eval $(dircolors ~/.dircolors/dircolors.ansi-dark)
...
PS1="\[$Green\]\t\[$Red\]-\[$Blue\]\u \[$Yellow\]\[$Yellow\]\w\[\033[m\]\[$Purple\]\$(__git_ps1)\[$Cyan\] \$ "
